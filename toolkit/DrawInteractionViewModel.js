define([
  ...
  var logger = Logger.getLogger("geoscene.widgets.DrawInteractionViewModel");
  ...
  return Evented.EventedMixin(
    ...
    declaredClass: "geoscene.widgets.DrawInteractionViewModel",
    ...
    constructor() {
      ...
      this.unsupportedErrorMessage =
        "DrawInteractionViewModel is only supported in 3D views.";
      this.ready = false;
      this.view = null;
